...
const NonActivatedProviders = ({ hospitals }) => {
  ...
  const activateProvider = (providerName) => {
    axios
      .patch(
        `https://polar-dusk-61658.herokuapp.com/admin/activate/provider/${providerName}`,
        "",
        { headers: { Authorization: `${token}` } }
      )
      .then((res) => {
        console.log(res.data);
        setMessage("Hospital Activated Successfully");
        setAl(true);
        setTimeout(() => {
      ...
      .catch((error) => {
        console.log(error);
        setMessage("Hospital Activation Failed");
        setAl(true);
        setSeverity("error");
        setTimeout(() => {
          window.location.reload(false);
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (
                              ...
                              activateProvider(hospital.providerName);
                          }}
                        >
                          Activate
                        </Button>
...
export default NonActivatedProviders;
